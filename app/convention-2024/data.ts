...
export const data: { speakers: (Speaker | KeynoteSpeaker)[]; workshops: Workshop[] } =
	{
		speakers: [
			{
		...
		workshops: [
			...
			},
			{
				...
				title: "Empowering Educators & Parents: Taking Care of You So You Can better take care of others",
				description:
			...
			},
			{
				...
				title: "Supporting gender expansive/transgender youth in early childhood settings",
				description:
			...
			},
			{
				day: "friday",
				speaker: "Janna Barkin",
				title: "Discussion group for parents, caregivers, family, & friends of transgender, non-binary, or gender questioning children",
				description:
			...
			},
			{
				day: "friday",
				speaker: "Taylor Ross",
				title: "re-orienting the difficult moments as opportunities for connection & growth",
				description:
			...
			},
			{
				...
				title: "embracing playfulness: cultivating a growth mindset in work & life",
				description:
			...
			},
			{
				...
				title: "my body and others: sexual education for parents and teachers of young kids",
				description:
			...
			},
			{
				...
				title: "Supporting young children to Reduce stress, build RESILIENCE & Heal from trauma through play",
				description:
			...
			},
			{
				...
				title: "introduction to the be body positive model for educators and parents",
				description:
			...
			},
			{
				...
				title: "the biology of play: tools for regulating your nervous system to optimize play",
				description:
			...
			},
			{
				day: "saturday",
				speakers: [
					"Marci Silverberg, MPT, PPCES & Caitlin MONDT, PT, DPT",
				],
			...
			},
			{
				...
				title: "beyond basic stem: strategies to grow young scientists by intergrating science, technology, engineering and math into regular preschool curriculum",
				description:
			...
			},
			{
				...
				title: "play with discipline - discipline with play: speak the language of children & children will follow yours",
				description:
			...
			},
			{
				...
				title: "learn how to tap the pain away so we can play: eft tapping therapy for children, parents, and teachers",
				description:
			...
			},
			{
				...
				title: "harmony in early learning: a purposeful playshop for parents and educators",
				description:
